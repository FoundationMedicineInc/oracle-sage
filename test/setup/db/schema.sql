...
DROP TABLE SEQUENCE_NO_TRIGGER CASCADE CONSTRAINTS ;
...
CREATE TABLE SEQUENCE_NO_TRIGGER
  ( SEQUENCE_NO_TRIGGER_ID NUMBER NOT NULL
  ) ;
ALTER TABLE SEQUENCE_NO_TRIGGER ADD CONSTRAINT SEQUENCE_NO_TRIGGER_PK PRIMARY KEY ( SEQUENCE_NO_TRIGGER_ID ) ;
...
CREATE SEQUENCE SEQUENCE_NO_TRIGGER_SEQUENCE_N START WITH 1 NOCACHE ORDER ;
