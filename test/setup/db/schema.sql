...
DROP TABLE SAGE_TEST.COMMENTS CASCADE CONSTRAINTS;
...
CREATE TABLE SAGE_TEST.COMMENTS
  (
    COMMENT_ID RAW (100) NOT NULL,
    LIKE_COUNT RAW (100),
    BODY BLOB
  );
ALTER TABLE SAGE_TEST.COMMENTS ADD CONSTRAINT COMMENTS_PK PRIMARY KEY ( COMMENT_ID );
